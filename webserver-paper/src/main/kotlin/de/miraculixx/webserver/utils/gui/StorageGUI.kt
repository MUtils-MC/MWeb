...
import de.miraculixx.webserver.utils.gui.items.Head64
import de.miraculixx.webserver.utils.gui.items.ItemFilterProvider
import de.miraculixx.webserver.utils.gui.items.ItemProvider
import de.miraculixx.webserver.utils.messages.*
import de.miraculixx.webserver.utils.serializer.toMap
        ...
        if (filterable) {
            i.setItem(49, itemStack(Material.HOPPER) {
                meta {
                    ...
                    persistentDataContainer.set(NamespacedKey("de.miraculixx.api", "gui.storage.filter"), PersistentDataType.STRING, (filter ?: "NO_FILTER"))
                }
            })
        }
